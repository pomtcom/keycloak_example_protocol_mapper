 ...
 * @version $Revision: 1 $
 */
public class HardcodedClaimV2 extends AbstractOIDCProtocolMapper implements OIDCAccessTokenMapper, OIDCIDTokenMapper, UserInfoTokenMapper {
    ...
    public static final String PROVIDER_ID = "oidc-pomtcom-claim-mapper-v2";
    ...
    public String getHelpText() {
        return "Hardcode a claim into the token. plus V2";
    }

    protected void setClaim(IDToken token, ProtocolMapperModel mappingModel, UserSessionModel userSession) {

        System.out.println("Hardcode V2 is executing") ;
        String attributeValue = mappingModel.getConfig().get(CLAIM_VALUE);
        if (attributeValue == null) return;
        attributeValue = attributeValue + "TESTAPPEND" ;
