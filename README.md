- For example of Keycloak custom protocol mapper.
- For keycloak version 8.0.1.
- Quick setup code for prototype of custom mapper spi (HardcodedClaimV2).
- In order to use:
    - cd to protocol-mapper directory.
    - mvn clean install -X.
    - copy .jar to keycloak standalone/deployments directory.
