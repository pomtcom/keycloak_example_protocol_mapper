...
RUN mkdir -p /opt/jboss/keycloak/modules/system/layers/base/pomtcom/schwartau/keycloak-custom-protocol-mapper-example/main
ADD ./protocol-mapper/target/keycloak-custom-protocol-mapper-example.jar /opt/jboss/keycloak/modules/system/layers/base/pomtcom/schwartau/keycloak-custom-protocol-mapper-example/main/keycloak-custom-protocol-mapper-example.jar
ADD ./protocol-mapper/src/main/module/module.xml /opt/jboss/keycloak/modules/system/layers/base/pomtcom/schwartau/keycloak-custom-protocol-mapper-example/main